...
///  referencias ao usuario seleccionado e as súas tarefas
...
// Función para seleccionar ou editar un usuario existente logo co botón gardar 
function editarUsuario(index) {
  ...
  Object.assign(novoUsuario, usuario);  // carga os datos do usuario no formulario recorda v-model do formulario é novoUsuario
   // Actualizamos a comunicación co fillo
  
  usuarioSeleccionado.value = usuario
  tarefasUsuario.value = [
    // Aquí poñemos tarefas de exemplo ou as que veñan da base de datos
